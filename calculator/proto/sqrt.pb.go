...
type SqrtRequest struct {
	...
	Number int32 `protobuf:"varint,1,opt,name=number,proto3" json:"number,omitempty"` // could be int 32
}
...
var file_sqrt_proto_rawDesc = []byte{
	...
	0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x61, 0x72, 0x61, 0x72, 0x61, 0x67, 0x65, 0x2f, 0x67, 0x72,
